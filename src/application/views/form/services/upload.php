        ...
        <td>
            <span class="preview">
                {% if (file.thumbnailUrl) { %}
                    ...
                    <a href="<?= base_url("thumb") ?>?src=/files/images/{%=file.name%}&sia={%=file.name%}" target="_blank" download style="margin-left: 30px;">
                        <span class="glyphicon glyphicon-download image-download-btn" aria-hidden="true" title="Скачать" style="font-size: 20px;"></span>
                    </a>
                {% } %}
            </span>
        </td>
...
<script src="<?= base_url('public/jquery.file.upload/js/load-image.all.min.js') ?>"></script>
<!-- The Canvas to Blob plugin is included for image resizing functionality -->
<script src="<?= base_url('public/jquery.file.upload/js/canvas-to-blob.min.js') ?>"></script>
<!-- Bootstrap JS is not required, but included for the responsive demo navigation -->
<script src="<?= base_url('public/bootstrap/js/bootstrap.min.js') ?>"></script>
<!-- blueimp Gallery script -->
<script src="<?= base_url('public/jquery.file.upload/js/jquery.blueimp-gallery.min.js') ?>"></script>
...
<script src="<?= base_url('public/jquery.file.upload/js/jquery.fileupload-image.js') ?>"></script>
<!-- The File Upload audio preview plugin -->
<script src="<?= base_url('public/jquery.file.upload/js/jquery.fileupload-audio.js') ?>"></script>
<!-- The File Upload video preview plugin -->
<script src="<?= base_url('public/jquery.file.upload/js/jquery.fileupload-video.js') ?>"></script>
...
<script>
    ...
    $(function () {
        ...
        $('#fileupload').fileupload({
            ...
            url: '<?= base_url('services/delivery/' . $delivery . '/server') ?>'
        });
