<div class="modal-header">
    ...
    <h4 class="modal-title" id="remoteDialogLabel">Редактировать вопрос</h4>
</div>
<div class="modal-body">
    ...
    <div class="form-group">
        <textarea class="form-control" id="TextQuestion" rows="5" placeholder="Текст вопроса"><?= $record['Question'] ?></textarea>
    </div>
